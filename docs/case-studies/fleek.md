...
::: callout **"Using IPFS nodes and encryption and database tools on IPFS, we can build apps and websites with the highest standard of data privacy and autonomy to date."**

_— Brett Shear, COO, Fleek_ :::

## Overview

::: right ![Fleek logo](../../.gitbook/assets/logo-fleek.png) :::
...
::: callout **"The future of Fleek is very closely tied to the future of IPFS. Fleek products are already delivering cutting-edge performance on IPFS. Every step forward on the IPFS development roadmap will give us more tools to improve on that performance further."**
