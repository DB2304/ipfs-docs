...
::: callout **"It's a simple, elegant use case. Everyone accessing a document has complete assurance they are viewing the official version, so you don't need any additional verification."**

_— Noam Eppel, COO and co-founder, Morpheus.Network_ :::

## Overview

::: right ![Morpheus.Network logo](../../.gitbook/assets/logo-morpheus.png) :::
...
![Digital Footprint example](../../.gitbook/assets/img-morpheus-digitalfootprint.png)
...
::: callout **"It's not that clients need to trust us, Morpheus.Network. They're trusting the cryptographic proof that a file's hash has remained the same, so they know with certainty that the file has not been edited or tampered with. From a business perspective, that really is one of the key benefits."**

_— Noam Eppel, COO and co-founder, Morpheus.Network_ :::

## How Morpheus.Network uses IPFS

As noted above, Morpheus.Network's integration of IPFS was extremely straightforward. With the help of IPFS [documentation](../) and an extensive [developer community](../community/), the team was able to use standard IPFS tooling without any need for additional customization.
