...
description: >-
  Some IPFS features are disabled or not defaults, but we encourage their use
  under the right circumstances. We list them here for easy access by busy
  builders.
---
...
* [Pin files using IPFS](pin-files.md#three-kinds-of-pins).
...
* [Subdomain gateway](address-ipfs-on-web.md#subdomain-gateway)
* [DNSLink gateway](address-ipfs-on-web.md#http-gateways)
