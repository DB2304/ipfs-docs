...
::: callout If you are looking for [single-page application (SPA)](https://en.wikipedia.org/wiki/Single-page_application) support, see [redirects and custom 404s](redirects-and-custom-404s.md) instead. :::
...
| [Windows](single-page-website.md#windows)                                                          | [macOS](single-page-website.md#macos)                                                        | [Linux](single-page-website.md#linux)                                                  |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| [![Windows icon](<../../../.gitbook/assets/windows-icon (1).png>)](single-page-website.md#windows) | [![macOS icon](<../../../.gitbook/assets/apple-icon (1).png>)](single-page-website.md#macos) | [![Linux icon](../../../.gitbook/assets/linux-icon.png)](single-page-website.md#linux) |

Already downloaded? you can [Skip this step](single-page-website.md#add-your-site)
...
1.  Download the latest available `.exe` file from the [IPFS desktop downloads page](https://github.com/ipfs/ipfs-desktop/releases):
    ...
    ![The IPFS desktop download page.](<../../../.gitbook/assets/install-windows-download-exe-page (1).png>)
...
3.  Select whether you want to install the application for just yourself or all users on the computer. Click **Next**:
    ...
    ![The IPFS desktop install options window.](<../../../.gitbook/assets/install-windows-install-options (1).png>)
4.  Select the install location for the application. The default location is usually fine. Click **Next**:

    ![The IPFS desktop installation location window.](<../../../.gitbook/assets/install-windows-install-location (1).png>)
5.  Wait for the installation to finish and click **Finish**:

    ![The IPFS desktop installation finished window.](<../../../.gitbook/assets/install-windows-install-finish (1).png>)
6.  You can now find an IPFS icon in the status bar:

    ![The IPFS desktop status bar menu in the Windows status bar.](<../../../.gitbook/assets/install-windows-ipfs-desktop-status-bar (1).png>)

The IPFS desktop application has finished installing. You can now start to [add your site](single-page-website.md#add-your-site).
...
1.  Download the latest available `.dmg` file from the [IPFS desktop downloads page](https://github.com/ipfs/ipfs-desktop/releases):
    ...
    ![List of available download links in GitHub.](<../../../.gitbook/assets/install-macos-dmg-file-link (1).png>)
2. Open the `ipfs-desktop.dmg` file.
3.  Drag the IPFS icon into the **Applications** folder:

    ![Drag-to-install window in MacOS.](<../../../.gitbook/assets/install-macos-drag-ipfs-drag (1).png>)
...
5.  You may get a warning saying _IPFS Desktop.app can't be opened_. Click **Show in Finder**:
    ...
    ![Application cannot be installed error.](<../../../.gitbook/assets/install-macos-ipfs-cannot-be-opened (1).png>)
6. Find **IPFS Desktop.app** in your **Applications** folder.
7.  Hold down the `control` key, click **IPFS Desktop.app**, and click **Open**:

    ![Right click context menu of IPFS Desktop.app.](<../../../.gitbook/assets/install-macos-force-open (1).png>)
8.  Click **Open** in the new window:

    ![Open confirmation window.](<../../../.gitbook/assets/install-macos-open-confirmation (1).png>)
9.  You can now find an IPFS icon in the status bar:

    ![The IPFS desktop status bar menu in the macOS status bar.](<../../../.gitbook/assets/install-macos-ipfs-desktop-status-bar (1).png>)
...
2.  Open the `.deb` package in **Software Installer**:
    ...
    ![Right-click context menu of the IPFS deb package.](../../../.gitbook/assets/install-ubuntu-software-install.png)
3.  Click **Install** and wait for the installation to finish:

    ![Install screen within the Ubuntu software installation window.](../../../.gitbook/assets/install-ubuntu-install.png)
4. Click **Applications** or press the Windows key on your keyboard.
5.  Search for `IPFS` and select **IPFS Desktop**:

    ![Ubuntu search screen with IPFS desktop showing.](../../../.gitbook/assets/install-ubuntu-search-window.png)
6.  You can now find an IPFS icon in the status bar:

    ![IPFS icon shown in the Ubuntu status bar.](../../../.gitbook/assets/install-ubuntu-ipfs-running-status-bar.png)
...
4.  Navigate to your `index.html` file and select **Open**.
    ...
    ![Choose a file window open in IPFS desktop.](../../../.gitbook/assets/add-ipfs-desktop-open-file.png)
5. Click the triple dot menu on `index.html` and select **Share link**.
6.  Click **Copy** to copy the file's URL to your clipboard.

    ![Share files window in IPFS desktop.](../../../.gitbook/assets/add-ipfs-desktop-share-files.png)
...
![IPFS Desktop application showing the pinning option.](../../../.gitbook/assets/ipfs-desktop-showing-pinning.png)
...
5.  You should be able to see your `index.html` file pinned:
    ...
    ![The Pinata Pin Explorer screen showing the index.html pinned.](../../../.gitbook/assets/pinned-index-file-in-pinata.png)
6.  Click your `index.html` file to open your website through the Pinata gateway.

    ![Random planet fact website pinned using Pinata and displayed in Firefox](../../../.gitbook/assets/pinned-random-planet-fact-website.png)
...
5.  In your domain name providers **Redirection Settings** section, paste in the **IPFS Hash** link you just copied.
    ...
    ![Redirecting a source URL to an IPFS Hash link within Namecheap.](../../../.gitbook/assets/namecheap-source-url-redirect.png)
6. Save your changes.
...
![Random planet facts site with the randomplanetfacts.xyz URL.](../../../.gitbook/assets/random-planets-with-correct-url.png)
