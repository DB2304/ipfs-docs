...
description: >-
  Learn how to publish content with IPFS by pinning a file to a pinning service
...
* [Overview](publish_cli.md#overview)
* [Pinning services](publish_cli.md#pinning-services)
* [Prerequisites](publish_cli.md#prerequisites)
* [Uploading and pinning a file](publish_cli.md#uploading-and-pinning-a-file)
* [CIDs explained](publish_cli.md#cids-explained)
* [Retrieving with a gateway](publish_cli.md#retrieving-with-a-gateway)
* [Summary and next steps](publish_cli.md#summary-and-next-steps)
...
1.  Install the [w3 command line interface](https://github.com/web3-storage/w3cli).
    ...
    ```
2.  Authorize the w3 tool to act on behalf of the account associated with your email address `<your@email.com>`:
